...
function handleRequest(_request, _response) {
    return __awaiter(this, void 0, void 0, function () {
        var url, recipe, jsonString, allRecipes;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!_request.url) return [3 /*break*/, 4];
                    url = Url.parse(_request.url, true);
                    if (!(url.query["type"] === "post")) return [3 /*break*/, 2];
                    recipe = JSON.parse(url.query["recipe"]);
                    return [4 /*yield*/, recipes.insertOne(recipe)];
                case 1:
                    _a.sent();
                    jsonString = JSON.stringify(recipe);
                    _response.write(jsonString);
                    return [3 /*break*/, 4];
                case 2:
                    if (!(url.query["type"] === "get")) return [3 /*break*/, 4];
                    return [4 /*yield*/, recipes.find().toArray()];
                case 3:
                    allRecipes = _a.sent();
